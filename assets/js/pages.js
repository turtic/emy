...
const htmlPages = [page0, page1, page2, page3, page4];

const htmlSmallPages = [smallPage0, smallPage1, smallPage2, smallPage3, smallPage4];

export  {htmlPages, htmlSmallPages};